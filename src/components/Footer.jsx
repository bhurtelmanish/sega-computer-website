...
const Footer = () => {
  return (
    <>
     <section className="py-10 bg-gray-900 sm:pt-16 lg:pt-24 mt-10">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="flex flex-wrap items-center justify-between">
            <img className="h-10 auto md:order-1 cursor-pointer" src={logo} alt="Sega computer link" />
            ...
            <p className="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto md:order-2">© Copyright 2021, All Rights Reserved by Sega Computer Link</p>
        </div>
    </div>
</section>
